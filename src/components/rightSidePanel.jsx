  ...
  return (
    <aside className="rightPanel">
      <ToolsBar
        ...
        onHemisphereSelected={setHemisphereSelected}
        fovSelected={fovSelected}
        onFovSelected={setFovSelected}
        setHoveredFov={setHoveredFov}
      />
      ...
      <section className="extraInfoContainer">
        <div className="extraInfo fovInfo">
          <img
            ...
            onMouseOver={(e) => {
              e.currentTarget.src = zoomFovImages[fovSelected];
            }}
            onMouseOut={(e) => {
              e.currentTarget.src = fovImages[hoveredFov || fovSelected];
            }}
          />
        </div>
